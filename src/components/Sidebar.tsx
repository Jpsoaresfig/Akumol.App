      ...
      <aside className="hidden lg:flex w-64 bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 flex-col transition-all duration-300 h-screen sticky top-0">
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 space-y-1">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2 rounded-xl text-xs font-bold transition-all text-amber-500 hover:text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-500/10"
          >
            <Crown size={16} />
